...
BEGIN_MESSAGE_MAP(CMFC_CNCSystemApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFC_CNCSystemApp 建構

CMFC_CNCSystemApp::CMFC_CNCSystemApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_CNCSystemApp 物件

CMFC_CNCSystemApp theApp;


// CMFC_CNCSystemApp 初始設定

BOOL CMFC_CNCSystemApp::InitInstance()
{
